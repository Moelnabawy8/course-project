    ...
    $subcategoryResult=$subcategory->read();
    $product=new Product();
    $product->setStatus(1); 
...
if ($categoriesResult) {
    ...
    $subcategories = $subcategoryResult ? $subcategoryResult->fetch_all(MYSQLI_ASSOC) : [];
                                    ...
                                    <ul>
                                        ...
                                        if ($resultProduct) {
                                            ...
                                            <div class="shopping-cart-img">
                                                <a href="#"><img alt="" src="assets/img/product/<?php echo $product['image'] ?>"></a>
                                            </div>
